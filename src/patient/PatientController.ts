...
export class PatientController {
  ...
  @Get('/')
  @ApiOperation({ summary: 'Список Пациент' })
  ...
  @ApiOperation({ summary: 'Получить один Пациент по идентификатору' })
  ...
  @ApiOperation({ summary: 'Создать Пациент' })
  ...
  @Patch('/:patientId')
  @ApiParam({ name: 'patientId', type: Number })
  @ApiOperation({ summary: 'Обновить Пациент' })
  ...
  @ApiParam({ name: 'patientId', type: Number })
  @ApiOperation({ summary: 'Удалить Пациент' })
